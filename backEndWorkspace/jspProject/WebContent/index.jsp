...
<body>
	<h1>JSP</h1>
	<p>JSP란, HTML 형식 내에서 자바코드를 사용할 수 있는 "자바 언어"로<br>
	서블릿(java코드) 내에서 응답하면 html을 구현했던 복잡함을 보다 간단하게 작성, 해결할 수 있다.<Br>
	->즉, JSP의 가장 큰 장점은 Servlet에서는 비즈니스 로직 처리에만 집중하고 응답화면을<br>
	만들어내는 것은 JSP에서 하게끔 분리할 수 있다.
	</p>
	<h1>JSP Elements 표현법</h1>
	<p> JSP 페이지에 자바코드를 직접 기술할 수 있게 해주는 기능</p>
	<ol>
		<li> 선언문 : &lt;%! 자바코드   %&gt; 
